...
namespace Models.Customer.Enterprise.Organizate
{
    ...
    public class InstitutionsStatePeriod
    {
        ...
        /// 信息记录类型
        /// </summary>
        [Display(Name = "信息记录类型"), StringLength(1), Required, AN(ErrorMessage = "信息记录类型 类型错误")]
        ...
        /// 基本户状态
        /// </summary>
        [Display(Name = "基本户状态"), StringLength(1), AN(ErrorMessage = "基本户状态 类型错误")]
        public string BasicAccountState { get; set; }

        /// <summary>
        /// 企业规模
        /// </summary>
        [Display(Name = "企业规模"), StringLength(1), AN(ErrorMessage = "企业规模 类型错误")]
        public string EnterpriseScale { get; set; }

        /// <summary>
        /// 机构状态
        /// </summary>
        [Display(Name = "机构状态"), StringLength(1), AN(ErrorMessage = "机构状态 类型错误")]
