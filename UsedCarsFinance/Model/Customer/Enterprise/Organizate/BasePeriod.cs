...
namespace Model.Customer.Enterprise.Organizate
{
    ...
    public class BasePeriod
    {
        ...
        /// 客户号
        /// </summary>
        [Display(Name = "客户号"), StringLength(40), Required, AN(ErrorMessage = "客户号类型错误")]
        public string CustomerNumber { get; set; }

        /// <summary>
        /// 管理行代码
        /// </summary>
        [Display(Name = "管理行代码"), StringLength(20), Required, AN(ErrorMessage = "管理行代码类型错误")]
        public string ManagementerCode { get; set; }

        /// <summary>
        /// 客户类型
        /// </summary>
        [Display(Name = "客户类型"), StringLength(1), Required, AN(ErrorMessage = "客户类型类型错误")]
        ...
        /// 开户许可证核准号
        /// </summary>
        [Display(Name = "开户许可证核准号"), StringLength(20), AN(ErrorMessage = "开户许可证核准号类型错误")]
        public string NewaccountlicenseNumber { get; set; }

        /// <summary>
        /// 贷款卡编码
        /// </summary>
        [Display(Name = "贷款卡编码"), StringLength(16), AN(ErrorMessage = "贷款卡编码类型错误")]
        public string LoanCardCode { get; set; }

        /// <summary>
        /// 数据提取日期
        /// </summary>
        [Display(Name = "数据提取日期"), StringLength(8), Required, N(ErrorMessage = "数据提取日期类型错误")]
