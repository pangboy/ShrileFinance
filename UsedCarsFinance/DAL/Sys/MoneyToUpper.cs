...
{
    /// <summary>
    /// 数字转大写类，使用方法 string rmb = BLL.Sys.MoneyToUpper.RMBToUpper("12222.00");
    /// </summary>
    /// cais    16.04.25
    ...
    public class MoneyToUpper
    {
        ...
        public string RMBToUpper(string numstr,int digit)
        {
            try
            {
                decimal num = Math.Round(Convert.ToDecimal(numstr), digit);
                return this.RMBToUpper(num);
            }
            catch
            {
                return "非数字形式！";
        ...
        public string RMBToUpper(decimal numstr, int digit)
        {
            try
            {
                decimal num = Math.Round(numstr, digit);
                return this.RMBToUpper(num);
            }
            catch
            {
